...
const Page = () => {
    ...
    const [formData, setFormData] = useState({ event_name: "",  start_time_hour: "", duration_hrs: ""});
    ...
    const onFinish = (event) => {
      ...
      addEvent(formData.event_name, false, user_name, date_year, date_month, date_day, formData.start_time_hour,  formData.duration_hrs)
        .then(() => {
